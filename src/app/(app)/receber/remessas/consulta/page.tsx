...
export default function ConsultaRemessasReceberPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-xl font-bold tracking-tight">Consulta de Remessas — Cobrança</h1>
        <p className="text-sm text-muted-foreground">Contas a Receber › Remessas › Consulta</p>
      </div>
        ...
        <div className="flex gap-3">
          ...
          <Select value={statusFilter} onValueChange={setStatusFilter}>
            ...
            <SelectContent>
              ...
              <SelectItem value="RETURNED">Com Retorno</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </CardContent></Card>
